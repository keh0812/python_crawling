        ...
        # try:
            ...
            while next_exists:
                ...
                try:
                    ...
                    # javascript:fn_search(71); 숫자만 추출
                    next_btn_href_id = re.sub(r'[^0-9]', '', str(next_btn_href))
                    print("next_btn_href_id : ", next_btn_href_id)
                    print(" 현재 페이지 : ", paging_num)

                    if next_btn_href_id == paging_num:
                        print("### href 숫자와 현재 페이지 비교 - 마지막 페이지 ###")
                        next_exists = False
                    ...
                    # none이 포함되지 않는 경우(다음 페이지 있음)
                    # https://www.humanrights.go.kr/site/program/board/basicboard/list
                    else:
