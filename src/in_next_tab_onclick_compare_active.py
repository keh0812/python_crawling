...
class CrawlingPagingMain():
    ...
    def crawling_main(self, collection_data):
        ...
        # try:
            ...
            while next_exists:
                ...
                try:
                    ...
                    next_btn_onclick = driver.find_element_by_css_selector(next_tag).get_attribute('onclick')
                    print("next_btn_onclick == ", next_btn_onclick)

                    # javascript:fn_search(71); 숫자만 추출
                    next_btn_onclick_id = re.sub(r'[^0-9]', '', str(next_btn_onclick))
                    print("next_btn_href_id ==>> ", next_btn_onclick_id)
                    print(" 현재 페이지 == ", paging_num)

                    if next_btn_onclick_id == paging_num:
                        print("### onclick 숫자와 현재 페이지 비교 - 마지막 페이지 ###")
                        next_exists = False
                    
                    # 다음 탭(페이지) 있음
                    # javascript:{gotoPage(21)}
                    else:
                        next_btn.click()
                        print("### 다음 버튼 클릭 ###")
        ...
        #     print(str(datetime.timedelta(seconds=end_seconds)))
