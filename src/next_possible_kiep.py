...
# 수집 날짜 범위
start_str = "20211130000000"
end_str = "20211101000000"
        ...
        # try:
            ...
            while next_exists:
                ...
                for paging_index in range (paging_cnt):
                    ...
                    next_js_text_sp = re.sub(r'[^0-9]', '', next_js)

                    # print("next_js_text_sp =============>>>", next_js_text_sp)
                    # print("paging_num =============>>>", paging_num)

                    if next_js_text_sp != paging_num:
