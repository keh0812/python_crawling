        ...
        # try:
            ...
            while next_exists:
                ...
                for paging_index in range (paging_cnt):
                    ...
                    paging_num = paging_all_items[paging_index].text
                    
                    # 첫페이지 확인
                    if paging_index > 0:
                        
                        driver.execute_script("arguments[0].scrollIntoView(true);", paging_all_items[paging_index])
                        if headless_height != "0":
                            driver.execute_script("window.scrollTo(0, window.scrollY - " + headless_height + ");")

                        time.sleep(3)

                        paging_all_items[paging_index].click()
                    ...
                    if (detail_tag != ""):
                        ...
                        for i in range (item_cnt):
                            ...
                            # 상세페이지 기본 타입
                                ...
                                if current_paging_url == driver.current_url :

                                    # 상세페이지 url
                                    detail_url = driver.current_url
                                    continue
                                else :
                                    print("비정상 상세페이지 PASS")
                                    driver.back()
                                    break
