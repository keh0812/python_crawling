...
class CrawlingPagingMain():
    ...
    def crawling_main(self, collection_data):
        ...
        # try:
            ...
            # 페이징 정보
            paging_bar = paging_data['paging_bar']
            ...
            while next_exists:
                    ...
                    driver.execute_script("arguments[0].scrollIntoView(true);", driver.find_element_by_css_selector(paging_bar))
                    time.sleep(30)

                    # 페이징 요소 찾기
                    paging_all_items = driver.find_elements_by_css_selector(".js-algolia-pagination > nav > ul > li > a")           
                    paging_next_btn = []
                    ...
                    for items in paging_all_items :
                        ...
                        if items.text == "Next page" :
                            paging_next_btn.append(items)

                    try:
                        if paging_next_btn[0].text == "Next page" :
